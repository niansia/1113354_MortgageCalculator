...
namespace _1113354_陳冠瑋_房貸計算器
{
    public partial class Form1 : Form
    {
        ...
        private void ShowRentVsBuy()
        {
            if (totalLoan <= 0)
            {
                MessageBox.Show("請先完成試算，再開啟租買模型。", "提示", MessageBoxButtons.OK, MessageBoxIcon.Information);
                return;
            }
        ...
        private void ToggleInputMode()
        {
            ...
            if (tableLayoutPanelInput.RowStyles.Count > 8)
            {
                ...
                tableLayoutPanelInput.RowStyles[7].Height = _advancedInputVisible ? 84F : 0F;
